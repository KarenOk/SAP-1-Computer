...
HD_PWD='C:/Users/CAChukwulobe/Documents/Vivado_Project_1/SAP1/SAP1_FINAL/SAP1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SAP1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SAP1.tcl

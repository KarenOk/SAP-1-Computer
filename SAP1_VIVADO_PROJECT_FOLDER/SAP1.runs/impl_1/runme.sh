...
HD_PWD='C:/Users/CAChukwulobe/Documents/Vivado_Project_1/SAP1/SAP1_FINAL/SAP1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SAP1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SAP1.tcl -notrace
